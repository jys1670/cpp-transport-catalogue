...
\DoxyCodeLine{116   \textcolor{comment}{// Let's inherit all constructors of variant}}
\DoxyCodeLine{117   \textcolor{keyword}{using }variant::variant;}
\DoxyCodeLine{118 }
\DoxyCodeLine{119   \mbox{\hyperlink{classjson_1_1Node}{Node}}(Node::Value \&\&val);}
\DoxyCodeLine{120   \mbox{\hyperlink{classjson_1_1Node}{Node}}(\textcolor{keyword}{const} \mbox{\hyperlink{classjson_1_1Document}{Document}} \&doc);}
\DoxyCodeLine{121 }
\DoxyCodeLine{122   \textcolor{keywordtype}{bool} IsInt() \textcolor{keyword}{const};}
\DoxyCodeLine{123   \textcolor{keywordtype}{bool} IsDouble() \textcolor{keyword}{const};}
\DoxyCodeLine{124   \textcolor{keywordtype}{bool} IsPureDouble() \textcolor{keyword}{const};}
\DoxyCodeLine{125   \textcolor{keywordtype}{bool} IsBool() \textcolor{keyword}{const};}
\DoxyCodeLine{126   \textcolor{keywordtype}{bool} IsString() \textcolor{keyword}{const};}
\DoxyCodeLine{127   \textcolor{keywordtype}{bool} IsNull() \textcolor{keyword}{const};}
\DoxyCodeLine{128   \textcolor{keywordtype}{bool} IsArray() \textcolor{keyword}{const};}
\DoxyCodeLine{129   \textcolor{keywordtype}{bool} IsMap() \textcolor{keyword}{const};}
\DoxyCodeLine{130 }
\DoxyCodeLine{131   \textcolor{keywordtype}{int} AsInt() \textcolor{keyword}{const};}
\DoxyCodeLine{132   \textcolor{keywordtype}{bool} AsBool() \textcolor{keyword}{const};}
\DoxyCodeLine{133   \textcolor{keywordtype}{double} AsDouble() \textcolor{keyword}{const};}
\DoxyCodeLine{134   \textcolor{keyword}{const} std::string \&AsString() \textcolor{keyword}{const};}
\DoxyCodeLine{135   \textcolor{keyword}{const} Array \&AsArray() \textcolor{keyword}{const};}
\DoxyCodeLine{136   \textcolor{keyword}{const} \mbox{\hyperlink{namespacejson_a14165bfd985e982794b3697b71cc4a01}{Dict}} \&AsMap() \textcolor{keyword}{const};}
\DoxyCodeLine{137 }
\DoxyCodeLine{138   \textcolor{keyword}{const} Value \&GetConstValue() \textcolor{keyword}{const};}
\DoxyCodeLine{139   Value \&GetValue();}
\DoxyCodeLine{140 \};}
\DoxyCodeLine{141 }
\DoxyCodeLine{143 \textcolor{keyword}{class }\mbox{\hyperlink{classjson_1_1Document}{Document}} \{}
\DoxyCodeLine{144 \textcolor{keyword}{public}:}
\DoxyCodeLine{145   \textcolor{keyword}{explicit} \mbox{\hyperlink{classjson_1_1Document}{Document}}(\mbox{\hyperlink{classjson_1_1Node}{Node}} root);}
\DoxyCodeLine{146 }
\DoxyCodeLine{147   \textcolor{keyword}{const} \mbox{\hyperlink{classjson_1_1Node}{Node}} \&GetRoot() \textcolor{keyword}{const};}
\DoxyCodeLine{148 }
\DoxyCodeLine{149 \textcolor{keyword}{private}:}
\DoxyCodeLine{150   \mbox{\hyperlink{classjson_1_1Node}{Node}} root\_;}
\DoxyCodeLine{151 \};}
\DoxyCodeLine{152 }
\DoxyCodeLine{153 \} \textcolor{comment}{// namespace json}}
