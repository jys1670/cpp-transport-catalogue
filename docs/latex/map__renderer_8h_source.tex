...
\label{map__renderer_8h_source}\index{/home/user/Documents/cpp-\/transport-\/catalogue/transport-\/catalogue/map\_renderer.h@{/home/user/Documents/cpp-\/transport-\/catalogue/transport-\/catalogue/map\_renderer.h}}
...
\DoxyCodeLine{39   \mbox{\hyperlink{classgraphics_1_1SphereProjector_a3bcf4c098f5aa6718a180eafd0df2614}{SphereProjector}}(PointInputIt points\_begin, PointInputIt points\_end,}
...
\DoxyCodeLine{62   std::string \mbox{\hyperlink{classgraphics_1_1MapRenderer_a6dbd1648432a4eb2646e94a2c6cebe06}{RenderMap}}(\mbox{\hyperlink{structcore_1_1data_1_1RoutesData}{core::data::RoutesData}} data);}
\DoxyCodeLine{67   \textcolor{keywordtype}{void} \mbox{\hyperlink{classgraphics_1_1MapRenderer_a77ffbeb6d2ec35a5c70b9e5255c27241}{LoadSettings}}(\textcolor{keyword}{const} \mbox{\hyperlink{classio_1_1json_1_1Node}{io::json::Node}} \&node);}
\DoxyCodeLine{68 }
\DoxyCodeLine{69 \textcolor{keyword}{private}:}
\DoxyCodeLine{71   \mbox{\hyperlink{structgraphics_1_1RenderSettings}{RenderSettings}} \mbox{\hyperlink{classgraphics_1_1MapRenderer_a5449dd810215a65dc3be27502528d394}{settings\_}};}
\DoxyCodeLine{72 }
\DoxyCodeLine{73   \textcolor{keyword}{static} svg::Color ParseColor(\textcolor{keyword}{const} \mbox{\hyperlink{classio_1_1json_1_1Node}{io::json::Node}} \&node);}
\DoxyCodeLine{74 }
\DoxyCodeLine{75   \textcolor{keywordtype}{void} DrawRoutes(\mbox{\hyperlink{structcore_1_1data_1_1RoutesData}{core::data::RoutesData}} \&data, \mbox{\hyperlink{classgraphics_1_1SphereProjector}{SphereProjector}} \&projector,}
\DoxyCodeLine{76                   \mbox{\hyperlink{classgraphics_1_1svg_1_1Document}{svg::Document}} \&doc);}
\DoxyCodeLine{77 }
\DoxyCodeLine{78   \textcolor{keywordtype}{void} DrawRouteNames(\mbox{\hyperlink{structcore_1_1data_1_1RoutesData}{core::data::RoutesData}} \&data, \mbox{\hyperlink{classgraphics_1_1SphereProjector}{SphereProjector}} \&projector,}
\DoxyCodeLine{79                       \mbox{\hyperlink{classgraphics_1_1svg_1_1Document}{svg::Document}} \&doc);}
\DoxyCodeLine{80 }
\DoxyCodeLine{81   \textcolor{keywordtype}{void} DrawStopSymbols(\mbox{\hyperlink{structcore_1_1data_1_1RoutesData}{core::data::RoutesData}} \&data, \mbox{\hyperlink{classgraphics_1_1SphereProjector}{SphereProjector}} \&projector,}
\DoxyCodeLine{82                        \mbox{\hyperlink{classgraphics_1_1svg_1_1Document}{svg::Document}} \&doc);}
\DoxyCodeLine{83 }
\DoxyCodeLine{84   \textcolor{keywordtype}{void} DrawStopNames(\mbox{\hyperlink{structcore_1_1data_1_1RoutesData}{core::data::RoutesData}} \&data, \mbox{\hyperlink{classgraphics_1_1SphereProjector}{SphereProjector}} \&projector,}
\DoxyCodeLine{85                      \mbox{\hyperlink{classgraphics_1_1svg_1_1Document}{svg::Document}} \&doc);}
\DoxyCodeLine{86 }
\DoxyCodeLine{87   svg::Color DeserializeColor(\textcolor{keyword}{const} serialization::Color \&color);}
\DoxyCodeLine{88 \};}
\DoxyCodeLine{89 }
